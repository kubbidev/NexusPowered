...
public abstract class ExtendedJavaPlugin extends JavaPlugin implements NexusPlugin {
    ...
    @Override
    public <T extends CommandExecutor> @NotNull T registerCommand(@NotNull T command, String permission, Component permissionMessage, String description, @NotNull String... aliases) {
