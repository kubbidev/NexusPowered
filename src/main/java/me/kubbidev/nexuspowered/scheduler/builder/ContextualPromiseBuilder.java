...
/**
 * Builds instances of {@link Promise}, often combining parameters with variables already known by this instance.
 */
public interface ContextualPromiseBuilder {
    ...
    @NotNull Promise<Void> run(@NotNull Runnable runnable);
