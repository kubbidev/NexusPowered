...
/**
 * A bucket is an extension of {@link Set}, which allows contained elements to be separated into parts by a
 * {@link PartitioningStrategy}.
 *
 * <p>The performance of {@link Bucket} should be largely similar to the performance
 * of the underlying {@link Set}. Elements are stored twice - once in a set containing all elements in the bucket, and
 * again in a set representing each partition.</p>
 *
...
public interface Bucket<E> extends Set<E> {
     ...
     */
    @NotNull BucketPartition<E> getPartition(int i);
     ...
     */
    @NotNull List<BucketPartition<E>> getPartitions();
     ...
     */
    @NotNull Cycle<BucketPartition<E>> asCycle();
