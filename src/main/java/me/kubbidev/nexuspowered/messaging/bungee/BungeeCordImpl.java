...
public final class BungeeCordImpl implements BungeeCord, PluginMessageListener {
    ...
    private void sendToChannel(MessageAgent agent, Player player) {
        ...
        if (agent instanceof MessageCallback callback) {
    ...
    private record ConnectAgent(Player player, String serverName) implements MessageAgent {
    ...
    private record ConnectOtherAgent(String playerName, String serverName) implements MessageAgent {
    ...
    private record IPAgent(Player player,
                           Promise<Map.Entry<String, Integer>> callback) implements MessageAgent, MessageCallback {
    ...
    private record PlayerCountAgent(String serverName,
                                    Promise<Integer> callback) implements MessageAgent, MessageCallback {
    ...
    private record PlayerListAgent(String serverName,
                                   Promise<List<String>> callback) implements MessageAgent, MessageCallback {
    ...
    private record GetServersAgent(Promise<List<String>> callback) implements MessageAgent, MessageCallback {
    ...
    private record PlayerMessageAgent(String playerName, String message) implements MessageAgent {
    ...
    private record GetServerAgent(Promise<String> callback) implements MessageAgent, MessageCallback {
    ...
    private record UUIDAgent(Player player, Promise<UUID> callback) implements MessageAgent, MessageCallback {
    ...
    private record UUIDOtherAgent(String playerName, Promise<UUID> callback) implements MessageAgent, MessageCallback {
    ...
    private record ServerIPAgent(String serverName,
                                 Promise<Map.Entry<String, Integer>> callback) implements MessageAgent, MessageCallback {
    ...
    private record KickPlayerAgent(String playerName, String reason) implements MessageAgent {
    ...
    private record ForwardCustomCallback(String getSubChannel, Predicate<byte[]> callback) implements MessageCallback {
