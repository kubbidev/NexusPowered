...
public interface ProtocolSubscriptionBuilder extends SubscriptionBuilder<PacketEvent> {
     ...
     */
    static @NotNull ProtocolSubscriptionBuilder newBuilder(@NotNull PacketType... packets) {
     ...
     * @return a {@link ProtocolSubscriptionBuilder} to construct the event handler
     */
    static @NotNull ProtocolSubscriptionBuilder newBuilder(@NotNull ListenerPriority priority,
    ...
    @Override
    default @NotNull ProtocolSubscriptionBuilder expireIf(@NotNull Predicate<PacketEvent> predicate) {
        return expireIf(Delegates.predicateToBiPredicateSecond(predicate), ExpiryTestStage.PRE,
            ExpiryTestStage.POST_HANDLE);
    }

    @Override
    default @NotNull ProtocolSubscriptionBuilder expireAfter(long duration, @NotNull TimeUnit unit) {
    ...
    @Override
    default @NotNull ProtocolSubscriptionBuilder expireAfter(long maxCalls) {
    ...
    @Override
    @NotNull ProtocolSubscriptionBuilder filter(@NotNull Predicate<PacketEvent> predicate);
     ...
     */
    @NotNull ProtocolSubscriptionBuilder expireIf(@NotNull BiPredicate<ProtocolSubscription, PacketEvent> predicate,
     ...
     */
    @NotNull ProtocolSubscriptionBuilder exceptionConsumer(
        @NotNull BiConsumer<? super PacketEvent, Throwable> consumer);
     ...
     */
    @NotNull ProtocolHandlerList handlers();
     ...
     */
    default @NotNull ProtocolSubscription handler(@NotNull Consumer<? super PacketEvent> handler) {
     ...
     * @throws NullPointerException if the handler is null
     */
    default @NotNull ProtocolSubscription biHandler(
