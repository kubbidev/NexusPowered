...
class FunctionalCommandBuilderImpl<T extends CommandSender> implements FunctionalCommandBuilder<T> {
    ...
    private FunctionalCommandBuilderImpl(ImmutableList.Builder<Predicate<CommandContext<?>>> predicates,
                                         ...
                                         @Nullable String description, @Nullable Component permissionMessage) {
    ...
    @Override
    public FunctionalCommandBuilder<T> assertPermission(String permission, @Nullable Component failureMessage) {
    ...
    @Override
    public FunctionalCommandBuilder<T> assertFunction(Predicate<? super CommandContext<? extends T>> test, @Nullable Component failureMessage) {
    ...
    public FunctionalCommandBuilder<T> assertUsage(String usage, Component failureMessage) {
        ...
        this.predicates.add(context -> {
            ...
            context.reply(failureMessage.replaceText(b -> b
                    .matchLiteral("{usage}").replacement("/" + context.label() + " " + usage)
            ));
            return false;
        });
    ...
    @Override
    public FunctionalCommandBuilder<T> assertArgument(int index, Predicate<String> test, Component failureMessage) {
        ...
        this.predicates.add(context -> {
            ...
            context.reply(failureMessage
                    .replaceText(b -> b.matchLiteral("{arg}").replacement(arg != null ? arg : "null"))
                    .replaceText(b -> b.matchLiteral("{index}").replacement(Integer.toString(index)))
            );
            return false;
        });
        return this;
